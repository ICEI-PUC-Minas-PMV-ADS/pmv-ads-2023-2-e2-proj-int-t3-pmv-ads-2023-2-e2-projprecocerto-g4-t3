...
namespace PrecoCerto.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Itens,Valor,Data,Horario,Total,UsuarioId")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Itens,Valor,Data,Horario,Total,UsuarioId")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
