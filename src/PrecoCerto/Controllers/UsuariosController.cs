...
namespace PrecoCerto.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Senha,Endereco,Telefone")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Senha,Endereco,Telefone")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
